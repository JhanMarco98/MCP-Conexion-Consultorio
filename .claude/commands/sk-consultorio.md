...
SELECT
    ...
    CASE
        ...
        WHEN T1.ESPECIALIDAD IN ('CIRUGÍA DE TIROIDES','PROCTOLOGIA','CIRUGÍA DE HERNIA','CIRUGÍA DE REFLUJO ESOFÁGICO','CIRUGÍA BARIATRICA / METABÓLICA') THEN 'CIRUGIA GENERAL ADULTO'
        ...
        WHEN T1.ESPECIALIDAD = 'NEUROCIRUGÍA, NEURORRADIOLOGÍA Y RADIOLOGÍA INTERVENCIONISTA' THEN 'NEUROCIRUGIA'
